...
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '서울 도심 속 숲세권, 북한산 자락길 힐링 투어', 45, '15만원', '북한산 산책 후 함박스테이크 맛집 방문', 320, NOW(), 0, 'user01');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '러너들의 성지! 여의도 한강 러닝과 고기 파티', 82, '10만원', '러너스테이션 체험 및 여의도 맛집 탐방', 540, NOW(), 0, 'user01');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '롤파크 직관부터 명동 L7 호텔까지 종로 정복', 120, '25만원', 'LCK 경기 관람 후 을지로 맛집 투어', 1200, NOW(), 0, 'user02');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '노을캠핑장 불멍과 감성 호텔 호캉스 추천', 67, '20만원', '캠핑장 고기 파티와 영등포 루프탑 즐기기', 890, NOW(), 0, 'user03');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '압구정 수상스키와 파르나스 호텔 1박 2일', 34, '80만원', '한강 수상레저 체험 및 호텔 다이닝', 410, NOW(), 1, 'user04');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '사당청소년센터 실내 액티비티 가성비 코스', 21, '5만원', '실내 스포츠 즐기기 및 주변 분식 맛집', 150, NOW(), 0, 'user05');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '이태원 텅앤그루브와 부티크 호텔의 만남', 56, '30만원', '이태원 프리미엄 고기 맛집과 호텔 스테이', 670, NOW(), 0, 'user06');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '장충체육관 직관 후 즐기는 평양냉면 코스', 95, '12만원', '배구 경기 관람 및 장충동 미식 여행', 1050, NOW(), 1, 'user07');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '성수동 멕시칼리와 힙한 건대 호텔 라이프', 73, '18만원', '타코 맛집 대기 성공 및 성수 쇼핑 투어', 920, NOW(), 0, 'user08');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '특별한 날 추천! 남산 야경과 반얀트리 스파', 150, '120만원', '반얀트리 체크인 및 남산 타워 산책', 2100, NOW(), 0, 'user09');


-- 11. 장충동 체육관 직관과 써미트 호텔 휴식
INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '장충체육관 배구 직관 후 즐기는 호캉스', 38, '22만원', '경기 관람 후 장충동 족발 먹고 호텔 투숙', 420, NOW(), 0, 'user07');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '홍은동 북한산 자락길 무장애 산책로 탐방', 25, '8만원', '산책로 걷기 및 인근 베이커리 카페 방문', 280, NOW(), 0, 'user01');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '삼성동 럭셔리 데이트: 카지노와 파르나스 다이닝', 52, '50만원', '카지노 구경 후 호텔 라운지에서 저녁 식사', 710, NOW(), 1, 'user10');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '성북동 노포 맛집 부수기 (중국집 & 국수)', 89, '6만원', '옛날중국집 짜장면 시식 및 성북동 산책', 1150, NOW(), 0, 'user09');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '여의도 둘레길 자전거 한 바퀴와 피크닉', 64, '4만원', '자전거 대여 라이딩 후 여의나루 치맥', 830, NOW(), 0, 'user03');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), '남산 아래 이태원 고급 파인다이닝 코스', 110, '35만원', '라 쿠치나 코스 요리와 부티크 호텔 스테이', 1520, NOW(), 0, 'user06');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), 'MZ 성지 건대 힙플 투어와 가성비 호텔', 47, '12만원', '커먼그라운드 쇼핑 및 건대 맛집 탐방', 660, NOW(), 0, 'user08');

INSERT INTO SCHEDULE_POST (POST_ID, TITLE, LIKE_COUNT, BUDGET_DETAILS, TODO_DETAILS, VIEW_COUNT, POSTED_AT, IS_ANONYMOUS, USER_ID)
VALUES (CONCAT('P', LPAD(NEXT VALUE FOR SEQ_MY_SCHEDULE, 3, '0')), 'LCK 직관하고 즐기는 만리지화 한정식', 76, '18만원', '이스포츠 관람 후 부모님과 식사하기 좋은 곳', 980, NOW(), 0, 'user02');
...
-- 11. 장충체육관 배구 직관 후 즐기는 호캉스 (P045)
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 1, 2, '6', 'P045', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 2, 1, '36', 'P045', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 3, 0, '55', 'P045', 'POST');

INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 1, 3, '1', 'P044', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 2, 0, '51', 'P044', 'POST');

INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 1, 1, '18', 'P043', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 2, 0, '50', 'P043', 'POST');

INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 1, 1, '32', 'P042', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 2, 2, '37', 'P042', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 3, 0, '47', 'P042', 'POST');

INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 1, 2, '12', 'P041', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 2, 5, '8', 'P041', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 3, 0, '41', 'P041', 'POST');

INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 1, 2, '27', 'P040', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 2, 0, '43', 'P040', 'POST');

INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 1, 3, '25', 'P039', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 2, 0, '56', 'P039', 'POST');

INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 1, 1, '9', 'P038', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 2, 2, '24', 'P038', 'POST');
INSERT INTO VISIT_ITEM (VISIT_ITEM_ID, VISIT_ORDER, DISTANCE_TO_NEXT, PLACE_ID, SCHEDULE_ID, SCHEDULE_TYPE)
VALUES (NEXT VALUE FOR SEQ_VISIT_ITEM, 3, 0, '42', 'P038', 'POST');
